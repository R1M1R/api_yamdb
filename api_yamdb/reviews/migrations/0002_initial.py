# Generated by Django 3.2 on 2023-06-17 07:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='review',
            name='title',
            field=models.ForeignKey(help_text='Выберете произведение, чтобы оставить свой отзыв', on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='reviews.title', verbose_name='Произведение'),
        ),
        migrations.AddField(
